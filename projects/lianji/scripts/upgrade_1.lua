...
function intoLogin()
    ...
    while true do
        if findPic_boolean("qiehuanzhanghao.bmp",90, 290,658 , 348,782 )then
            ...
            mSleep(2000)
            return
        elseif findPic_boolean("jinruyouxi.bmp",90,  16,382 , 171,738 )then
            --点击进入游戏
            click(x,y)
            if findPic_boolean("qiehuanzhanghao.bmp",90, 290,658 , 348,782 )then
                click(x,y)
                ...
                mSleep(1500)
                return
            elseif findPic_boolean("juesehuitui.bmp",90, 586,2, 637,59  )then
                click(x,y)
            end
        elseif findPic_boolean("juesehuitui.bmp",90, 586,2, 637,59  )then
            click(x,y)
    ...
    while true do
        ...
        if findPic_boolean("zhanghao.bmp",90, 406,330 , 468,432 ) then
            ...
            if findPic_boolean("lijidenglu.bmp",90, 221,492 , 287,646 ) then
                click(x,y)
                mSleep(2000)
                if findPic("tongyixieyi.bmp",90,  66,774 , 108,866 ) or
                findPic("jinruyouxi.bmp",90,  61,619 , 151,699 ) then
                    click(x,y)
                    notifyMessage("账号登陆成功1")
                    logD("账号登陆成功1")
                    mSleep(2000)
                    return
                end
...
function exception()
    ...
    --精彩内容
    if findPic_boolean("jingcaineirong.bmp",90, 539,887 , 625,981 ) then
        clicklp(x,y)
    end
    --关闭离线挂机界面
