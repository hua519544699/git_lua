...
function caijiliangshi()
    ...
    while true do
        ...
        elseif findPicLostColor_boolean("liangshi_cj.bmp",75, 115,327 , 560,727 ,0xFF00FF) then
            click(x+5,y+5)
            mSleep(1000)
        elseif findPic_boolean("fanhui_cj.bmp",90, 169,192 , 241,230 ) then
        ...
        elseif findPic_boolean("jiasu_cj.bmp",90, 169,192 , 241,230 ) then
...
--            click(x+5,y+5)
--            mSleep(1000)
--        elseif findPic_boolean("fanhui_cj.bmp",90, 179,127 , 232,174 ) then
--            notifyMessage("采集正在返回中",300)
--            logD("采集正在返回中")
--            mSleep(1000)
--            findPic("iconchengbao_cj.bmp",90,  43,1068,  96,1125)
--            return
--        elseif findPic_boolean("jiasu_cj.bmp",90, 178,132 , 233,173 ) then
--            notifyMessage("采集正在加速中",300)
--            logD("采集正在加速中")
--            mSleep(1000)
--            findPic("iconchengbao_cj.bmp",90,  43,1068,  96,1125)
...
function jiaochang()
    while true do
        if findPic_boolean("youshangditu.bmp",90, 423,404 , 529,491 ) then
            ...
            while true do
                --点击校场
                if findPic_boolean("jiaochang.bmp",90, 103,740 , 258,836 ) then
                    click(x,y)
                    --升级校场
...
function liaowangta()
    while true do
        if findPic_boolean("youshangditu.bmp",90, 423,404 , 529,491 ) then
            ...
            while true do
                --点击瞭望塔
                if findPic_boolean("liaowangta_lw.bmp",90, 411,686 , 458,728 ) then
                    click(x,y)
            ...
            if findPic_boolean("youxiaditu.bmp",90, 556,738 , 617,796 ) then
                ...
                while true do
                    ...
                    elseif findPic_boolean("jianzaoz_td.bmp",90, 287,883 , 352,940 ) then
                        --如果是农田和伐木场就建造
                        if findPic_boolean("icontian_td.bmp",90, 437,415 , 496,457 ) or
                        findPic_boolean("iconfamu_td.bmp",90, 437,415 , 496,457 )then
...
function lianmengjuanxian()
    if findPic_boolean("ditu_sl.bmp",90,  28,1061, 103,1125) then
        ...
        logD("联盟捐献")
        mSleep(1000)
        local mutou,xiaomai = panduanshu()
                    ...
                    if findPic_boolean("yanjiuIcon_xy.bmp",90, 175,443 , 401,783 ) then
                        ...
                        while true do
                            ...
                            if findPic_boolean("ziyuanjiemian_xy.bmp",90, 277,13  , 355,59  ) then
                                if findPic_boolean("shiyong_xy.bmp",90, 491,228 , 561,286 ) then
                                    click(x,y)
                                    --使用资源最大
...
function xueyuanliang()
    while true do
        --募兵术
        if findPic_boolean("mubingshuli_xy.bmp",90, 223,81  , 413,267 ) then
            click(x,y)
            --制图学
...
--城堡发展
function chengbao()
    if findPic_boolean("zuoshangditu.bmp",90,  70,590 , 141,655 ) then
        notifyMessage("找到左上角地块",300)
        logD("找到左上角地块")
        mSleep(1000)
        while true do
            --点击城堡
...
function bingying()
    ...
    while true do
        ...
        if findPic_boolean("zuoshangditu.bmp",90,  70,590 , 141,655 ) then
            ...
            --超时时间
            while true do
                local chaoshi1 = os.time()
                if chaoshi1 - chaoshi >60 then
                ...
                or findPic_boolean("zhanchegongfang1_fz.bmp",90, 189,307 , 450,467 ) then
                    ...
                    --训练2级冲车
                    if findPic_boolean("chongche2ji_fz.bmp",90, 393,349 , 502,455 ) then
                        --点击训练按钮
                        ...
                        if findPic_boolean("bingying_fz.bmp",90,180,490 , 519,700) then
                            click(x,y)
                            --点击训练
                            findPic("xunlianIcon1_fz.bmp",90,   1,392 , 636,780 )
                            findPic("xunlianIcon1_fz.bmp",90,   1,392 , 636,780 )
                            findPic("xunlianIcon1-1_fz.bmp",90, 388,679 , 501,777)
                            --点击训练按钮
                            findPic("xunliananniu_fz.bmp",90, 399,1048, 490,1112)
...
function kaiqichuizi()
    ...
    if findPic_boolean("iconditu.bmp",90,  27,1062, 108,1128) then
        while true do
            if findPic_boolean("jinchuizi.bmp",90,  50,278 ,  82,305 ) then
                click(x,y)
            ...
            elseif findPic_boolean("jinchuizi5.bmp",90,   2,229 ,  97,333 ) then
                click(x,y)
            elseif findPic_boolean("guyong.bmp",90, 274,650 , 358,710 ) then
                --点击雇佣
                click(x,y)
                mSleep(1000)
...
function jiarulianmeng()
    --加入联盟
    if findPic_boolean("jiaru_qc.bmp",90, 282,857 , 356,906 ) then
        click(x,y)
    ...
    if findPic_boolean("beibao_bag.bmp",90, 294,1066, 359,1128) then
        ...
        while true do
            ...
            elseif findPic_boolean("xiaocailiao1h_bag.bmp",75,  13,356 , 319,558 ) then
                temp = 1
            elseif findPic_boolean("xinniantezhi2h_bag.bmp",75,  15,519 , 322,727 ) then
                temp = 1
            elseif findPic_boolean("huodejinbi2h_bag.bmp",75,  5,519 , 322,727 ) then
                temp = 1
            elseif findPic_boolean("huodejinbi2h_bag.bmp",75,  5,519 , 322,727 ) then
                temp = 1
            ...
            if  temp == 1 then
                ...
                if findPic_boolean("shiyong_bag.bmp",80, 448,463 , 595,537 ) then
                    click(x,y)
                    mSleep(1500)
                elseif findPic_boolean("shiyong_bag.bmp",80, 452,631 , 595,693 ) then
                    click(x,y)
                    mSleep(1500)
                elseif findPic_boolean("shiyong_bag.bmp",80, 450,789 , 597,855 ) then
                    click(x,y)
                    mSleep(1500)
                end
                --使用资源最大
    ...
    if findPic_boolean("beibao_bag.bmp",90, 294,1066, 359,1128) then
        ...
        while true do
            ...
            elseif findPic_boolean("ziyuanbaoxiang_bag.bmp",75,  77,380 , 191,423 ) then
                ...
                notifyMessage("找到",300)
                mSleep(1000)
            elseif findPic_boolean("shiyonghou_bag.bmp",75,  35,454 , 117,493 ) then
            ...
            elseif findPic_boolean("ziyuanbaoxiang_bag.bmp",75,  77,380 , 191,423 ) then
                ...
                notifyMessage("找到",300)
                mSleep(1000)
            elseif findPic_boolean("VIP_bag.bmp",90,  32,451 ,  98,500 ) then
                temp = 1    
                notifyMessage("找到",300)
                mSleep(1000)
            elseif findPic_boolean("VIPdianshu_bag.bmp",90,  37,455 ,  96,493 ) then
                temp = 1    
                notifyMessage("找到",300)
                mSleep(1000)
        ...
        if findPic_boolean("youjian.bmp",90, 422,1069, 480,1124) then
            ...
            if findPic_boolean("xitongxinxi.bmp",90,  16,596 ,  90,664 ) then
                ...
                while true do
                    ...
                    --收取
                    if findPic_boolean("shouqu_xtyj.bmp",90, 241,430 , 382,1044) then
                        click(x,y)
                    elseif findPic_boolean("shouquVIP_xtyj.bmp",90, 237,328 , 398,1056) then
                        click(x,y)
                    elseif findPic_boolean("shanchu_xtyj.bmp",90, 411,1059, 465,1125) then
                        click(x,y)
                    end
                    --确定删除
                    findPic("quedingshanchu_xtyj.bmp",90, 276,657 , 350,724 )
...
function renwulingjiang()
    ...
    while true do
        ...
        elseif findPic_boolean("renwulingjiang.bmp",90, 492,383 , 569,438 ) then
            click(x,y)
            chaoshi = os.time()
            findPic("renwulingjiang1.bmp",90, 502,848 , 573,912 )
            findPic("renwulingjiang2.bmp",90, 495,1062, 577,1123)
...
function bindBlog()
    ...
    while true do
        exception()
        if findPic_boolean("renwutouxiang.bmp",90,  18,9   ,  69,53  ) then
            click(x,y)
...
function shezhi()
    while true do
        ...
        elseif findPic_boolean("guanbibangzhu.bmp",90,  17,23  ,  85,63  ) then
            click(x,y)
        elseif findPic_boolean("renwutouxiang.bmp",90,  18,9   ,  69,53  ) then
            click(x,y)
        elseif findPic_boolean("shezhi.bmp",90, 553,1052, 631,1130) then
            click(x,y)
    ...
    if yindao == 0 then
        while true do
            ...
            elseif findPic_boolean("jianshang7.bmp",90, 566,133 , 614,188 ) then
                click( 590,35  )
            elseif findPic_boolean("jianyou1.bmp",90,  11,150 ,  63,193 ) then
                findPic("ziyuanlifu.bmp",90, 124,143 , 183,200 )
            ...
            findPicLostColor_boolean("bachangzhaopai1.bmp",90, 289,405 , 355,450 ) then
                ...
                mSleep(800)
                if findPic_boolean("jinbijiasu.bmp",90, 338,680 , 425,785 )or
            ...
            findPic_boolean("jiasuchengbao.bmp",90, 365,518 , 480,612 ) then
                notifyMessage("加速城堡",300)
                mSleep(1000)
                --加速城堡
                findPic("jiasuchengbao.bmp",90, 365,518 , 480,612 )
                mSleep(1000)
            ...
            elseif findPic_boolean("jianxia8.bmp",90,  47,938 ,  85,970 ) then
                ...
                click(  65,1096)
            elseif findPic_boolean("ziyuanshiyong.bmp",90, 490,215 , 591,352 ) then
                click(x,y)
            ...
            findPic_boolean("tishi1.bmp",80,   5,906 ,  72,974 )then
                ...
                findPic("jiasu.bmp",90, 364,509 , 484,612 )
                ...
                --加速兵营
                findPic("jiasu1.bmp",90, 367,678 , 476,778 )
                --加速马厩
                findPic("jiasumajiu.bmp",90, 370,677 , 473,773 )
                --加速仓库
                findPic("jiasucangku.bmp",90, 319,529 , 416,618 )
                --加速城墙
                findPic("jiasuchengqiang.bmp",90, 318,717 , 414,805 )
                --战争堡垒地块
...
function exception()
    ...
    --每次签到
    findPic("shouquwuzi_qiandao.bmp",90, 264,803 , 387,864 )
    --加入联盟
    ...
    --热卖
    if findPic_boolean("remai.bmp",90, 274,161 , 365,229 ) then
        click( 561,200 )
    end
    --等级提升
